...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		FilterRegistration.Dynamic infinispanHotRodSession = servletContext.addFilter("infinispanHotRodSessionFilter", new InfinispanHotRodSessionFilter());
		infinispanHotRodSession.setInitParameter("configFile", "hotrod.properties");
		infinispanHotRodSession.setInitParameter("infinispanCache", "KHAN_SESSION");
		infinispanHotRodSession.setInitParameter("infinispanLoginCache", "KHAN_SESSION_LOGIN");
		infinispanHotRodSession.setInitParameter("sessionId", "__KSMSID__");
		infinispanHotRodSession.setInitParameter("domain", "");
		infinispanHotRodSession.setInitParameter("path", "/");
		infinispanHotRodSession.setInitParameter("secure", "false");
		infinispanHotRodSession.setInitParameter("httpOnly", "false");
		infinispanHotRodSession.setInitParameter("sessionTimeout", "30");
		infinispanHotRodSession.setInitParameter("excludeRegExp", "/.+\\.(html|jpg|jpeg|png|gif|js|css|swf)");
		infinispanHotRodSession.setInitParameter("allowDuplicateLogin", "false");
		infinispanHotRodSession.setInitParameter("logoutUrl", "/logouted.jsp");
		infinispanHotRodSession.setInitParameter("forceEncoding", "true");
		infinispanHotRodSession.setInitParameter("enableStatistics", "false");
		infinispanHotRodSession.setInitParameter("enableMemoryStatistics", "false");
		infinispanHotRodSession.addMappingForUrlPatterns(EnumSet.of(DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE, DispatcherType.ERROR), false, "/*");

		servletContext.addListener(new com.opennaru.khan.session.listener.SessionListener());
